...
import FileTypeShape from '../ui/FileTypeShape'
                            ...
                            <div className="min-h-96 grid sm:grid-cols-2 md:grid-cols- md:px-4 gap-4 ">
                                {
                                    [...Array(8)].map((_,idx)=>{
                                        return (
                                            <div key={idx} className="border rounded-lg  w-full p-4">
                                                <div className="h-10   w-full"></div>
                                                <div className="py-4 border rounded flex justify-center items-center w-full">
                                                    <FileTypeShape/>
                                                </div>
