...
const Notes = ({setIsAddNote, contact, bookingNotes, setBookingNotes}:{
    ...
    const fetchNotes = async () => {
        ...
        try {
            setIsFetching(true)
            const response = await fetch(`/api/appointments/notes/?bookingId=${null}&contactId=${contact.id}&workspaceId=${contact.workspaceId}`)
